...
public class Req {
    ...
    detected BLE messages and this list must be updated as new messages are detected; each list item
    ...
    • When long-click on an item of the detected messages list, the app must try to connect the device
